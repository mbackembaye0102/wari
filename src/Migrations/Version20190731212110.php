 ...
 */
final class Version20190731212110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD profil_id INT DEFAULT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP profil_id, CHANGE statut statut VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
